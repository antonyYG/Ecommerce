            ...
            <div class="flex justify-between items-center space-x-8">
                ...
                <h1 class="text-white">
                    <a href="/" class="inline-flex flex-col items-end">
                        <span class="text-2xl md:text-3xl leading-3 md:leading-6 font-semibold">
                            Ecommerce
                        </span>
                        <span class="text-xs">
                            Tienda online
                ...
                <div class="flex-1 hidden md:block">
                    <x-input oninput="search(this.value)" class="w-full" placeholder="Buscar por producto, Tienda , marca"></x-input>
                </div>
                            ...
                            @guest
                                ...
                                <div class="px-4 py-2 ">
                                    ...
                                    <p class="text-sm text-center mt-2">
                                        ¿No tienes cuenta? <a href="{{route('register')}}" class="text-purple-600 hover:underline">
                                            Registrate
                                        </a>
                                    </p>
